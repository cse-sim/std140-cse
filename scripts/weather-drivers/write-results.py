...
Sheet1.cell(column = 2, row = 5).value = "2020-03-12" # Program Version Release Date:
...
columns = [
  ...
  {'Name': "Relative Humidity (%)", 'Frequency': "Subhourly", 'Column': 3}, # output not generated by CSE
  {'Name': "Dewpoint Temperature (C)", 'Frequency': "Hourly", 'Column': 4},
  ...
  {'Name': "Wind Direction (degrees from North)", 'Frequency': "Hourly", 'Column': 8},
  {'Name': "Station Pressure (mbar)", 'Frequency': "Hourly", 'Column': 9},
  {'Name': "Total Cloud Cover (tenths of sky)", 'Frequency': "Hourly", 'Column': 10},
...
columns_to_skip = ["Relative Humidity (%)", "Opaque Cloud Cover (tenths of sky)"]
